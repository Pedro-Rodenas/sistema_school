        ...
        <section class="right-panel">
            ...
            <div class="login-social-wrapper">
                ...
                <div class="social-login">
                    <!-- Google -->
                    <a href="{{ route('social.redirect', ['provider' => 'google']) }}" class="btn-social google">
                    ...
                    <!-- GitHub -->
                    <!-- GitHub: Aquí se convierte el botón en un enlace que llama a la ruta 'social.redirect' con el proveedor 'github' -->
                    <a href="{{ route('social.redirect', ['provider' => 'github']) }}" class="btn-social github">
